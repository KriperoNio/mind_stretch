...
abstract class StorageRepository {
  ...
  Future<void> setValue(SectionProvider section, StorageContentKey key, String value);
  ...
  Future<void> saveModel(SectionProvider section, ContentWithSettingsModel model);
}
